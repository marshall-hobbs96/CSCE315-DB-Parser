...
public class DatabaseEngine{
	...
	public static ArrayList<ArrayList<String>> unionD(String table1Name, String table2Name){
		...
		if((table1Name == null) && (table2Name == null)) {
			...
			columns1 = table_stack.pop().datas;
			...
			pkey.add("stuff");
			table_stack.push(new Table("temp_table",union, pkey));
			return union;
			...
			if (columns1.size() != columns2.size()) {
				...
				System.out.println("Error, relations do not exists");
 	...
 	public static ArrayList<ArrayList<String>> differenceD(String table1Name, String table2Name){
		...
		ArrayList<String> pkey = new ArrayList<String>();
		pkey.add("stuff");
		table_stack.push(new Table("temp_table", difference, pkey));	
		return difference;
	}
	...
	public static ArrayList<ArrayList<String>> productD(String tableName1,String tableName2){
		...
		if((tableName1 == null) && (tableName2 == null)) {
			...
			if((exists1 == false)){
				...
				System.out.println("Error, relation " + tableName1 + " does not exist");
			...
			if((exists1 == false) || (exists2 == false)) {
				...
				if((exists1 == false) && (exists2 == true)){
					...
					System.out.println("Error " + tableName1 + " does not exist");
					
				}
				
				else if((exists1 == true) && (exists2 == false)) {
					
					System.out.println("Error " + tableName2 + " does not exist");
					
				}
				
				else {
					
					System.out.println("Error " + tableName1 + " and " + tableName2 + " does not exist");
		...
		ArrayList<String> pkey = new ArrayList<String>();
		pkey.add("stuff");
		table_stack.push(new Table("temp_table", product, pkey));
		return product;
	}
