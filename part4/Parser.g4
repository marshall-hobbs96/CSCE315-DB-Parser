...
update_cmd : 'UPDATE' relation_name 'SET' attribute_name '=' literal (',' literal)*		//updates a relation's attribute with a new attribute. Alternatively, just adds another attribute to the relation
